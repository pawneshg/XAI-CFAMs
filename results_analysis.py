...
weights = pd.read_csv('./results_feb5/weights.csv').to_numpy()
omega = pd.read_csv('./results_feb5/naive_omega.csv').to_numpy()
weights = weights[:, 1:]
omega = omega[:, 1:]
...
plt.savefig("./results_feb5/weights_vs_omega.png")
